...
const RelatedDoctors = ({docId, speciality}) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
        ...
        <div className="grid w-full grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0">
            {
        ...
        <button onClick={() => {navigate('/doctors'); scrollTo(0,0)} } className="bg-blue-50 px-12 py-3 text-gray-600 rounded-full mt-10">more..</button>
    </div>
  )
}
