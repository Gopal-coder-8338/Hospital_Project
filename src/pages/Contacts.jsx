    ...
    <div>
      ...
      <div className="my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <p className="text-gray-500">00000 Willms Station <br />Suite 000, Bangalore, India</p>
          <p className="text-gray-500">Tel: (000) 000-0000 <br />Email: ratantata@gmail.com</p>
