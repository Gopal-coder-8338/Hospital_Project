...
const MyProfile = () => {
  ...
  const [userData , setUserData] = useState({
    name : "Dolseware Vincent",
    image : assets.profile_pic,
    email : 'dolseware@gmail.com',
    phone : '+91 833 883 0583',
    address : {
      line1 : "45th cross, Newstreet",
      line2 : "Circle, ringroad, India"
    },
    gender : 'Male',
    dob : '2000-01-20'
  })
  ...
  return (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      <img className="w-36 rounded" src={userData.image}  alt={assets.name} />
      {
        isEdit
